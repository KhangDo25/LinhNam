      ...
      >
        ...
        <div className="max-w-md mx-auto px-6 py-20 text-center">
          <Card className="p-10" glow>
            <h1 className="font-heading text-3xl text-gold mb-4">
              Đặt hàng thành công
            </h1>

            <p className="text-sm text-bone/75 mb-2">
              Mã đơn: {orderId.slice(0, 8).toUpperCase()}
            </p>

            <p className="text-sm text-bone/60 mb-8">
              Đã trừ {total.toLocaleString("vi-VN")} Linh Thạch.
              Cảm ơn bạn đã mua tại Linh Nam.
            </p>
